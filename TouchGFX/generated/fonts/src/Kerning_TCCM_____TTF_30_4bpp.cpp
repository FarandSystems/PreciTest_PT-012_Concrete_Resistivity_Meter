...
KEEP extern const touchgfx::KerningNode kerning_TCCM_____TTF_30_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    ...
    { 0x0062, -1 },  // (First char = [0x0062, b], Second char = [0x002E, period], Kerning dist = -1)
    ...
    { 0x004A, -1 },  // (First char = [0x004A, J], Second char = [0x003A, colon], Kerning dist = -1)
