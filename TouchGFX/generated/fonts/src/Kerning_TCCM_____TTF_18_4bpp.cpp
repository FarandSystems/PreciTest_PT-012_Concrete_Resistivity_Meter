...
KEEP extern const touchgfx::KerningNode kerning_TCCM_____TTF_18_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    { 0x0066,  1 },  // (First char = [0x0066, f], Second char = [0x0020, space], Kerning dist = 1)
